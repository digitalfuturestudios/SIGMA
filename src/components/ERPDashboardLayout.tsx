      ...
      <aside className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col hidden md:flex">
        ...
        <div className="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`h-5 w-5 mr-3 ${isActive ? 'text-indigo-400' : 'text-slate-400 group-hover:text-slate-300'}`} />
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="flex items-center px-2">
            ...
            <span className="text-xs text-slate-400">Nodo RCITE: Conectado</span>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center cursor-pointer group">
              <div className="text-right mr-3 hidden sm:block">
                <p className="text-sm font-medium text-slate-200 group-hover:text-white transition-colors">Gerente Financiero</p>
                <p className="text-xs text-slate-500">Pragma Corp</p>
              </div>
              <UserCircle className="h-8 w-8 text-slate-400 group-hover:text-slate-300 transition-colors" />
            </div>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-auto p-6 md:p-8">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            {/* Header */}
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">Overview Ejecutivo</h1>
              <p className="text-slate-400 mt-1">Resumen operativo y financiero de la jornada.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-800/40 backdrop-blur border border-slate-700/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <h3 className="text-slate-400 text-sm font-medium">Títulos Valores Activos</h3>
                  <div className="p-2 bg-indigo-500/10 rounded-lg">
                    <DollarSign className="h-5 w-5 text-indigo-400" />
                  </div>
                </div>
                <div className="mt-4 flex items-baseline">
                  <p className="text-3xl font-semibold text-white">$1,245,890</p>
              ...
              <div className="bg-slate-800/40 backdrop-blur border border-slate-700/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <h3 className="text-slate-400 text-sm font-medium">Liquidez en Factoring</h3>
                  <div className="p-2 bg-blue-500/10 rounded-lg">
                    <Landmark className="h-5 w-5 text-blue-400" />
                  </div>
                </div>
                <div className="mt-4 flex items-baseline">
                  <p className="text-3xl font-semibold text-white">84.2%</p>
                  <p className="ml-2 text-sm font-medium text-slate-400">Tasa de conversión</p>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 backdrop-blur border border-slate-700/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <h3 className="text-slate-400 text-sm font-medium">Retenciones Sincronizadas</h3>
                ...
                <div className="mt-4 flex items-baseline">
                  ...
                  <p className="ml-2 text-sm font-medium text-slate-400">SENIAT Online</p>
                </div>
              </div>
            </div>
            ...
            {activeModule === 'tesoreria' ? (
              ...
              <div className="bg-slate-800/30 border border-slate-700/50 border-dashed rounded-2xl h-96 flex flex-col items-center justify-center relative overflow-hidden group">
                ...
                <h2 className="text-xl font-semibold text-slate-400">Módulo en Desarrollo</h2>
